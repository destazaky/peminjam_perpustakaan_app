...
import '../modules/peminjamaan/bindings/peminjamaan_binding.dart';
import '../modules/peminjamaan/views/peminjamaan_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.PEMINJAMAAN,
      page: () => const PeminjamaanView(),
      binding: PeminjamaanBinding(),
    ),
    GetPage(
      name: _Paths.REGISTER,
      page: () => const RegisterView(),
